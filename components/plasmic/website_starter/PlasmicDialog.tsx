...
import sty from "./PlasmicDialog.module.css"; // plasmic-import: 2NiAx_IOLi93/css
...
function PlasmicDialog__RenderFunc(props: {
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({ [sty["pcls_RLDvcVslrtHe"]]: true })}
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__jsCbo)}
              >
                <div
                  className={classNames(
                    projectcss.all,
